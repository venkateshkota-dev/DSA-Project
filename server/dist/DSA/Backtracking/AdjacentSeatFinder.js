...
exports.AdjacentSeatFinder = void 0;
class AdjacentSeatFinder {
    /**
    ...
    static *findGenerator(grid, k) {
        ...
        let minCost = Infinity;
        const current = [];
        function* backtrackHelper(index) {
            const currentCost = AdjacentSeatFinder.getCost(current);
...
exports.AdjacentSeatFinder = AdjacentSeatFinder;
